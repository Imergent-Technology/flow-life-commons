...
// thing published on the host. Browsers therefore load the app from the
// gateway port, and HMR websockets must connect back through that same port.
...
export default defineConfig({
  ...
  server: {
    ...
    port: 5173,
    strictPort: true,
    allowedHosts: ['guardian.flowlife.localhost'],
