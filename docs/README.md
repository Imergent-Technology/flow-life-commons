...
| [runbooks/](runbooks/) | Operational procedures (none yet; see its README) |

Start with the [charter](architecture/charter.md), then [getting started](development/getting-started.md).

The next epic's design is in [architecture/identity-and-access.md](architecture/identity-and-access.md) — designed, not yet implemented.
