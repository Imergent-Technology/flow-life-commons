...
- **Known residuals** (stated plainly rather than papered over):
  ...
  - **The browser journey depends on the network.** `./flow test e2e` calls the live breached-password service on purpose. Every other test fakes it and cannot reach the network.
